    ...
    <body class="font-sans antialiased bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        ...
        <header class="bg-white dark:bg-gray-800 shadow-sm">
            <div class="container mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center">
                    <img src="https://images.squarespace-cdn.com/content/v1/62e0135c30b113421289e809/1673137713508-55FBD023WMSG2QFANAS8/TheWeaklyCover.jpg" alt="Logo de la plateforme" class="h-10 w-10 mr-3 rounded-full">
                    <span class="text-xl font-bold text-gray-800 dark:text-white">The Weekly</span>
                </div>
                ...
                <nav class="flex items-center space-x-4">
                    @if (Route::has('login'))
                        @auth
                            ...
                            <div class="relative">
                                <button class="flex items-center text-gray-800 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition duration-300">
                                    {{ Auth::user()->name }}
                                ...
                                <!-- Menu déroulant -->
                                <div class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-700 rounded-lg shadow-lg py-2 hidden">
                                    <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                                        Profil
                                    </a>
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="block w-full text-left px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                                            Déconnexion
                                        </button>
                                    </form>
                                </div>
                            ...
                            <a href="{{ route('announcements.create') }}" class="text-gray-100 bg-blue-500 text-lg rounded-lg px-2 py-2 dark:text-white hover:text-blue-600 dark:hover:text-gray-100 transition duration-300">
                                Créer une annonce
                            </a>
                        @else
                            <!-- Boutons de connexion et d'inscription -->
                            <a href="{{ route('login') }}" class="text-gray-800 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition duration-300">
                                Connexion
                            </a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-300">
                                    Inscription
                                </a>
                            @endif
                        @endauth
        ...
        <main class="container mx-auto px-2 py-2">
            ...
            <div class="text-center mb-6">
                <h1 class="text-4xl font-semibold text-gray-800 dark:text-white">Annonces de la Semaine</h1>
                <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 max-w-2xl mx-auto">
                    Découvrez les dernières annonces publiées cette semaine.
                </p>
            </div>
                    ...
                    <div class="relative bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="px-3 py-1 bg-yellow-500 text-gray-700 text-lg font-semibold rounded-full">
                                    {{ $announcement->category->name ?? 'Aucune catégorie' }}
                                </span>
                            </div>
                        
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-white mt-2">
                                {{ $announcement->titre }}
                            </h2>
                            ...
                            <p class="text-lg font-semibold text-gray-800 dark:text-white mt-4">
                                @if ($announcement->prix)
                                    {{ number_format($announcement->prix, 2) }} €
                                @else
                                    Free
                                @endif
                            </p>
                            ...
                            <div class="flex items-center mt-4 space-x-2">
                                ...
                                <a href="{{ route('announcements.show', $announcement) }}" class="text-blue-600 text-xl dark:text-blue-400 hover:text-blue-500">
                                    <i class="fas fa-eye"></i> 
                                </a>

                                @if (Auth::check() && Auth::user()->id === $announcement->user_id)
                                    <a href="{{ route('announcements.edit', $announcement) }}" class="text-yellow-600 text-xl dark:text-yellow-400 hover:text-yellow-500">
